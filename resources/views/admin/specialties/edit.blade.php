...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content">
        {!! Form::model($specialty, ['route'=>['specialties.update',$specialty],'method'=>'PUT']) !!}
        <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" id="name" name="name" value="{{ old('name', $specialty->name) }}" class="form-control @error('name') is-invalid @enderror">
                @error('name')
