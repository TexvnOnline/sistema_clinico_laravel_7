...
@section('title','Editar cita de paciente')
@section('style')
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{route('back.patient.appointments', $user)}}">Citas</a></li>
        ...
        <div class="row">
          ...
          <div class="col-md-9">
            <div class="card">
                ...
                {!! Form::model($appointment, ['route'=>['back.patient.appointment.update',$user,$appointment],'method'=>'PUT']) !!}
