        ...
        <div class="row">
          ...
          <div class="col-md-9">
            <div class="card">
                ...
                {!! Form::open(['route'=>['clinical.data.store', $user], 'method'=>'POST']) !!} 
                </div><!-- /.card-header -->
                <div class="card-body">
                    <div class="tab-content">
                        <div class="form-group">
                            <label for="check_in">Fecha de alta</label>
                            <input type="date" class="form-control @error('check_in') is-invalid @enderror" name="check_in" value="{{ $user->clinic_data('check_in', $datas) }}" id="check_in" required>
                            @error('check_in')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('scholarship') is-invalid @enderror" name="scholarship" id="scholarship" value="{{ $user->clinic_data('scholarship', $datas) }}" required>
                            @error('scholarship')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
